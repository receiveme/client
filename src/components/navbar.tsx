            ...
            >
                ...
                <Popover.Group className="hidden lg:flex lg:gap-x-12">
                    <Popover className="relative">
                        <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-200 hover:text-gray-100 transition">
                            Features
                            <IconChevronDown
                        ...
                        >
                            <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-200/5">
                                <div className="p-4">
                                    {features.map((item) => (
                                        <div
                                            key={item.name}
                                ...
                                <div className="grid grid-cols-2 divide-x divide-gray-200/5 bg-gray-50">
                                    {callsToAction.map((item) => (
                                        <a
                                            key={item.name}
                                            href={item.href}
                                            className="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-gray-600 hover:bg-gray-100"
                                        >
                                            <item.icon
