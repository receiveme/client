                ...
                >
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-end p-4">
                        ...
                        <p className="text-gray-300">
                            PancakeSwap, a DeFi platform on Binance Smart Chain,
                            is a decentralized exchange (DEX) enabling users to
                            swap cryptocurrencies, provide liquidity, and earn
                            CAKE tokens. Dive into decentralized finance with
                            PancakeSwap's seamless, rewarding experience!
                        </p>
                    </div>
                </div>
                    ...
                    <div className="p-4 transition flex justify-between items-center hover:bg-[#ffffff2b] rounded-tl-xl rounded-tr-xl">
                        ...
                        <div>
                            <button
                                onClick={() =>
                                    checkCAKEBNB(
                                        "0xE70b8dc28E795738A772379E9D456E7d74f50aB5",
                                    )
                                }
                                className="
