...
export const GoToSiteModal = ({
    isOpen,
    setIsOpen,
    setIsSiteLinkClicked,
}: {
    isOpen: boolean;
    setIsOpen: Dispatch<SetStateAction<boolean>>;
    setIsSiteLinkClicked: Dispatch<SetStateAction<boolean>>;
}) => {
    return (
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-center shadow-xl transition-all">
                                ...
                                <div className="mt-4 text-black">
                                    You will be redirected to trxdomains site.
                                </div>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            localStorage.setItem(
                                                "trxdomains:site-link-clicked",
                                                "true",
                                            );

                                            window.open(
                                                "https://trxdomains.xyz/",
                                                "_blank",
                                            );
                                            setIsOpen(false);
                                            setIsSiteLinkClicked(true);
                                        }}
                                    >
                                        Continue
                                    </button>
