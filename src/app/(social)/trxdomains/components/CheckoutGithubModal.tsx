...
export const CheckoutGithubModal = ({
    isOpen,
    setIsOpen,
    setIsGithubLinkClicked,
}: {
    isOpen: boolean;
    setIsOpen: Dispatch<SetStateAction<boolean>>;
    setIsGithubLinkClicked: Dispatch<SetStateAction<boolean>>;
}) => {
    return (
                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-center shadow-xl transition-all">
                                ...
                                >
                                    Checkout trxdomains on github
                                </Dialog.Title>

                                <div className="mt-4 text-black">
                                    You will be redirected to github
                                    organization of trxdomains
                                </div>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            localStorage.setItem(
                                                "trxdomains:github-link-clicked",
                                                "true",
                                            );

                                            window.open(
                                                "https://github.com/TronWeb3Domains",
                                                "_blank",
                                            );
                                            setIsOpen(false);
