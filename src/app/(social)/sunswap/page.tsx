...
export default function SUNSwap() {
    ...
    useEffect(() => {
        ...
        const twitterLinkClicked =
            Boolean(localStorage?.getItem("sunswap:twitter-link-clicked")) ||
            false;

        setIsTwitterLinkClicked(twitterLinkClicked);

        const discordLinkClicked =
            Boolean(localStorage?.getItem("sunswap:discord-link-clicked")) ||
            false;
    ...
    return (
        <>
            ...
            <div
                className="
                    sunswap-socials
                    w-full  h-[100dvh] overflow-y-auto py-4 flex flex-col items-center justify-center
                    "
            >
                <div className="px-4 sm:max-w-xl md:max-w-3xl">
                    <div className="flex flex-col h-fit w-full rounded-xl relative">
                        <div
                            className="
                                ...
                                <div className="flex justify-between gap-4">
                                    <div>
                                        ...
                                        <p className="text-gray-300">
                                            SUN.io, a DeFi (DEX) platform on
                                            TRON blockchain enabling users to
                                            swap cryptocurrencies, pool & farm
                                            liquidity. Explore the realm of
                                            decentralized finance with SUNSwap!
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            >
                                ...
                                />
                                <span className="ml-3 font-bold">Discord</span>
                            </a>
                        </div>
                    </div>
                    {/* tasks section */}
                    <div className="bg-[#ff5858] mt-4 rounded-xl w-full">
                        <div className="flex flex-col">
                        ...
                        <div className="p-4 transition flex justify-between items-center hover:bg-[#ffffff2b] rounded-b-xl">
                            ...
                            >
                                <span className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray hover:underline hover:scale-105 transition truncate"></span>
                                </span>
                            </button>
                            <div>
                                <button
                    ...
                    <div className="flex flex-col h-fit w-full bg-[#ffffff2a] mt-4 rounded-xl relative">
                        <div className="flex flex-col">
                            {/* <div className="p-4 transition flex justify-between items-center hover:bg-[#ffffff2b] rounded-tl-xl rounded-tr-xl">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="p-4 transition flex justify-between items-center hover:bg-[#ffffff2b] rounded-bl-xl rounded-br-xl">
                                <a
                                    href="https://tronscan.org/#/contract/TQAvWQpT9H916GckwWDJNhYZvQMkuRL7PN"
                                    target="_blank"
                                >
                                    <div className="flex items-center">
                                        <img
                            ...
                            <div className="p-4 transition flex justify-between items-center hover:bg-[#ffffff2b] rounded-bl-xl rounded-br-xl">
                                <a
                                    href="https://tronscan.org/#/contract/TLSWrv7eC1AZCXkRjpqMZUmvgd99cj7pPF"
                                    target="_blank"
                                >
                                    <div className="flex items-center">
                                        <img
