            ...
            <div className="flex flex-col h-fit w-[30%] bg-[#ffffff2a] rounded-xl relative">
                ...
                <div className="flex flex-col">
                    ...
                    <a
                        ...
                        className="p-4 transition flex items-center hover:bg-[#ffffff2b]"
                    >
                        <img className="w-6" src="/icons/twitter.svg" />
                    ...
                    >
                        <img className="w-6" src="/icons/instagram.svg" />
                ...
                <div className="flex flex-col">
                    ...
                    >
                        <div className="flex items-center">
                            <img className="h-6" src="/icons/ethereum.svg" />
                    ...
                    >
                        <div className="flex items-center">
                            <img className="h-6" src="/icons/tron.svg" />
