...
export const AddSteamModal = ({
    ...
    setIsLinkClicked: Dispatch<SetStateAction<boolean>>;
}) => { 
    return (
                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-center shadow-xl transition-all">
                                ...
                                >
                                    Add awpswap.io on Steam
                                </Dialog.Title>

                                <div className="mt-4 text-black">
                                    You will be redirected to Steam Profile
                                    of awpswap
                                </div>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            localStorage.setItem(
                                                "awpswap:steam-link-clicked",
                                                "true",
                                            );

                                            window.open(
                                                "https://steamcommunity.com/profiles/76561199477157463",
                                                "_blank",
                                            );
                                            setIsOpen(false);
